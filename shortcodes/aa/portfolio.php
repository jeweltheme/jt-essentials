	            ...
	            <div class="container">
	                ...
	                <div class="portfolio-works masonry-3column">
		                ...
		                <?php if ( $portfolio_query->have_posts() ) { while ( $portfolio_query->have_posts() ) { $portfolio_query->the_post();
		                      ...
		                      $item_style = get_post_meta( $post->ID,'_aa_wp_portfolio_style',true );
...
add_shortcode( 'aa_wp_works', 'kc_aa_wp_works' );


function kc_aa_wp_works_params() {
	global $post;
...
add_action('init', 'kc_aa_wp_works_params', 99 );
